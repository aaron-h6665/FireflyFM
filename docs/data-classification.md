...
- Server storage: SHA-256 reference hash and assignment snapshot; two-hour expiry and one-time consumption remain enforced. Resuming rechecks the active membership and assigned checklist. Another account cannot resume the reference.
